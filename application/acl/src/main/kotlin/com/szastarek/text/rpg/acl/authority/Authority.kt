...
fun List<Authority>.hasAllFeaturesAccessAuthority(): Boolean = any { authority -> authority is AllFeaturesAuthority }
...
fun List<Authority>.mergeWith(overridingAuthorities: List<Authority>): List<Authority> {
	val otherEntityAccessAuthoritiesIdentifiers =
		overridingAuthorities.filterIsInstance<EntityAccessAuthority<*>>()
