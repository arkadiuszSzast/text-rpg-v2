...
data class AccountAggregate(
  ...
  fun getResetPasswordToken(tokenIssuer: JwtIssuer, jwtExpiration: Duration, clock: Clock): JwtToken {
  ...
  fun resetPassword(token: JwtToken, issuer: JwtIssuer, newPassword: RawPassword) = either {
    val jwtVerifier = JWT
  ...
  fun changePassword(currentPassword: RawPassword, newPassword: RawPassword) = either {
